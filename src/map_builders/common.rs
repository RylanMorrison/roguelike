...
/// Remove all unreachable areas from the map and return the most distant tile from the start
        ...
        if *tile == TileType::Floor {
            ...
            if distance_to_start == std::f32::MAX {
                ...
                *tile = TileType::Wall;
                ...
                // set as the exit if it's further away than the current exit
...
/// Generate a cellular noise map and divide it into spawn regions
        ...
        _ => {
            ...
            for brush_y in y - half_brush_size .. y + half_brush_size {
                for brush_x in x - half_brush_size .. x + half_brush_size {
                    if brush_x > 1 && brush_x < map.width - 1 && brush_y < map.height - 1 {

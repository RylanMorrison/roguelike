use super::{MapBuilder, Map, TileType, Position, spawner, 
    ...
    generate_voronoi_spawn_regions, Symmetry, paint};
...
impl DrunkardsWalkBuilder {
    ...
    fn build(&mut self) {
        ...
        self.starting_position = Position{ x: self.map.width / 2, y: self.map.width / 2 };
        ...
        // build the noise map for spawning entities

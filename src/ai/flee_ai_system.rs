use specs::prelude::*;
use crate::{spatial, MyTurn, WantsToFlee, Position, Map, Viewshed, EntityMoved};
pub struct FleeAI {}
...
impl<'a> System<'a> for FleeAI {
    ...
    fn run(&mut self, data: Self::SystemData) {
        ...
        for (entity, pos, flee, viewshed, _myturn) in (&entities, &mut positions, &want_flee, &mut viewsheds, &mut turns).join() {

...
pub fn game_over(ctx: &mut Rltk) -> GameOverResult {
    ...
    draw_batch.print_color_centered(
        18,
        &format!("You took {} total damage.", gamelog::get_event_count("Damage Taken")),
        ColorPair::new(orange(), black())
    );
    draw_batch.print_color_centered(
        19,
        &format!("You dealt {} total damage.", gamelog::get_event_count("Damage Dealt")),
        ColorPair::new(orange(), black())
    );
    draw_batch.print_color_centered(
        20,
        &format!("You killed {} enemies.", gamelog::get_event_count("Kill")),
